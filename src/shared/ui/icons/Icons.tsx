...
export const CheckCircle2: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const X: React.FC<IconProps> = ({ className = "", size = 16, onClick }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ShoppingCart: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Users: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  ...
  >
    ...
    <path d="m22 21-1.35-1.35A2.98 2.98 0 0 0 19 19H15v-2a4 4 0 0 0-4-4H6" />
  </svg>
);
...
export const Pause: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Truck: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Info: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const HelpCircle: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Lock: React.FC<IconProps> = ({ className = "", size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
