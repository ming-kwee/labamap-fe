...
export interface MasterProductDetail {
  ...
  /** Raw productAttributes map (name, price, gender, material, age-group, …). Needed so edit mode can restore
   *  domain/category attributes, not just the promoted scalars. */
