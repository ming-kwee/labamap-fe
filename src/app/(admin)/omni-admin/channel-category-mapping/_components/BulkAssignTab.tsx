...
// ─── Category browse modal (inline — same pattern as ProductTypeRulesTab) ─────
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {!loading && error && (
            <div className="px-4 py-4 space-y-2">
              ...
              <button
                onClick={() => loadLevel(browsePath.length > 0 ? browsePath[browsePath.length - 1].id : undefined, browsePath)}
